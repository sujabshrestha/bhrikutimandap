            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea type="text" class="form-control summernote" id="terms_and_conditions" name="terms_and_conditions"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="account_number"
                            value="{{ returnSiteSetting('bank_name') ?? old('bank_name') }}"
                    ...
                    <div class="form-group col-md-12">
                        <div class="custom-file-container" data-upload-id="qrImage">
                            <label>Payment QR Code <a href="javascript:void(0)" class="custom-file-container__image-clear"

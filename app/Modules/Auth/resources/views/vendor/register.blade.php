            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        <h1 class="">Register In to <a href="{{ route('vendor.register') }}"><span class="brand-name">Venue Booking System</span></a></h1>
                        {{-- {{ route('admin.user.register') }} --}}
                        <p class="signup-link">New Here? <a href="{{ route('vendor.login') }}">Already have an account?</a></p>

                        <form class="text-left" method="POST" action="{{ route('vendor.loginSubmit') }}" enctype="multipart/form-data">
                            @csrf

                    ...
                    <div class = "booking-selection-content d-lg-flex justify-content-lg-center">
                        <div class = "booking-selection-item d-flex align-items-center">
                            <div class = "input-group">
                                ...
                                <input type = "text" autocomplete="off" id="FromDate"  class = "form-control check-in-datepicker" placeholder="Check-In" name = "from_date">
                            </div>
                        </div>
                        ...
                        <div class = "booking-selection-item d-flex align-items-center">
                            <div class = "input-group">
                                ...
                                <input type = "text" autocomplete="off" class = "form-control check-out-datepicker" id="ToDate" placeholder="Check-Out" name = "to_date">
                            </div>
                        </div>

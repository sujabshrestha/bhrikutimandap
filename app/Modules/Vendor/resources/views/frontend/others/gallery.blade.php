                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="gallery-card h-100">
                                    <div class="gallery-card-img">
                                        <img src="{{ $item->image ?? asset('frontendfiles/assets/images/gallery-img-1.png') }}" alt="">
                                    </div>
                                    <div class="gallery-card-footer mt-3">
                                        <span class="d-block text-xs text-silver">{{ !is_null($item->created_at) ? $item->created_at->format('DS M Y') : '14th December 2021' }} </span>
